...
impl SecondStep {
    fn cipher_k(&self) -> (u128, u128){
        //in the fourth step we comput k1r1 + plentext -add_num_neg
        //do add_num_neg should < k1r1 + plentext ,here we take k1r1
        let add_num_neg: u128 = generate_random_u128_in_range(1,  self.selfk * self.selfr);
        ...
        let cipher_k2r1_plus_c = encrypt_instance.mut_and_add();
